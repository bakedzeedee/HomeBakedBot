...
import { getGifs } from '../api/tenorAPI.js';
import { findAndPlayClip, playHelper, sayShoutout } from './commandHelper.js';
import { getGroupLevel } from '../utility/userUtil.js';
import { NumUtil, StringUtil } from '../utility/commonUtility.js';
...
const clip = (target, context, query) => {
    const userPure = query.replace(/^@/gi, '');
    findAndPlayClip(target, userPure);
}
